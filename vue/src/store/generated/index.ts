...
import CrowLabsEpsilonCrowlabsEpsilonNest from './crow-labs/epsilon/crowlabs.epsilon.nest'
...
export default { 
  ...
  CrowLabsEpsilonCrowlabsEpsilonNest: load(CrowLabsEpsilonCrowlabsEpsilonNest, 'crowlabs.epsilon.nest'),
